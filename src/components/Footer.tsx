...
const Footer: React.FC = () => {
  return (
    <footer
      id="contact"
      className="bg-primary-darker text-gray-300 py-12 px-8 font-sans"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm leading-relaxed text-gray-400">
              Trosc is a vibrant student team from the Faculty of Computers and
              Information, dedicated to guiding learners through every track.
            </p>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center">
                <PhoneIcon />
                <span className="text-gray-400">01023456789</span>
              </li>
            </ul>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex items-center gap-3">
              {/* Facebook — TODO: replace href with your Facebook page URL */}
              <a
                href="#"
                target="_blank"
              ...
              {/* Instagram — TODO: replace href with your Instagram page URL */}
              <a
                href="#"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* LinkedIn — TODO: replace href with your LinkedIn page URL */}
              <a
                href="#"
                target="_blank"
                rel="noopener noreferrer"
